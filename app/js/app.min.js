...
var initSliderMobile = function initSliderMobile() {
  var mobileCarousel = function mobileCarousel() {
    var checkWidth = $(window).width();
    var owlPost = $(".js--slider-mobile");

    for (var i = 0; i < owlPost.length; i++) {
      if (checkWidth > 992) {
...
var initTeamParallax = function initTeamParallax() {
  var checkWidth = $(window).width();

  if (checkWidth > 992) {
    var tlTeamDesctop = gsap.timeline({
      scrollTrigger: {
    ...
    tlTeamDesctop.to(".team-item--1", {
      y: 150,
      ease: "none"
    }, 0);
    tlTeamDesctop.to(".team-item--2", {
      y: -150,
      ease: "none"
    }, 0);
  }
...
var onToogleAbout = function onToogleAbout() {
